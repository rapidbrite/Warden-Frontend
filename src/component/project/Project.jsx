    ...
    <div className="project">
      ...
      <div className="project__header">
        ...
        <div className="project__header__right">
          ...
          <Link to={`/main/project/${id}/board`} id = "project__header__right__link">
            <div>Board</div>
          </Link>
          <Link to={`/main/project/${id}/backlog`} id = "project__header__right__link">
            <div>Backlog</div>
          </Link>

          <Link to={`/main/project/${id}/timeline`} id = "project__header__right__link">
            <div>Timeline</div>
          </Link>

          <Link to={`/main/project/${id}/chat`} id = "project__header__right__link">
            <div>Chat</div>
          </Link>
        
          <Link to={`/main/project/${id}/invite`} id = "project__header__right__link">
            <div>Invite</div>
          </Link>
          <Link to={`/main/project/${id}/setting`} id = "project__header__right__link">
            <div>Setting</div>
          </Link>
          <input type = "text" placeholder = "Search" className="project__header__right__search"/>
        </div>
      </div>
      {/* body content */}
